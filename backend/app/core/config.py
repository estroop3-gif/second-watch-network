...
class Settings(BaseSettings):
    ...
    EMAIL_FROM_ADDRESS: str = os.getenv("EMAIL_FROM_ADDRESS", "noreply@theswn.com")
    ...
    STRIPE_ORDER_BASE_PRICE_ID: str = os.getenv("STRIPE_ORDER_BASE_PRICE_ID", "")
    STRIPE_ORDER_STEWARD_PRICE_ID: str = os.getenv("STRIPE_ORDER_STEWARD_PRICE_ID", "")
    STRIPE_ORDER_PATRON_PRICE_ID: str = os.getenv("STRIPE_ORDER_PATRON_PRICE_ID", "")
    STRIPE_FILMMAKER_PRO_MONTHLY_PRICE_ID: str = os.getenv("STRIPE_FILMMAKER_PRO_MONTHLY_PRICE_ID", "")
    STRIPE_FILMMAKER_PRO_ANNUAL_PRICE_ID: str = os.getenv("STRIPE_FILMMAKER_PRO_ANNUAL_PRICE_ID", "")
