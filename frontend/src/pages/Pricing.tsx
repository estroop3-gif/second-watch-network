...
const TIER_HIGHLIGHTS = [
  ...
  },
  {
    ...
    icon: Building2,
    features: ['50 Active projects', '3 Owner + 50 Collab seats', '5 TB Active / 10 TB Archive', '10 TB Bandwidth', 'All core modules included'],
  ...
  },
  {
    ...
    icon: Crown,
    features: ['Unlimited projects', '10 Owner + Unlimited Collab', '25 TB Active / 50 TB Archive', '50 TB Bandwidth', 'SSO, API, Dedicated CSM'],
