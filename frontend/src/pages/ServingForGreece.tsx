    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-16">
        ...
        <p className="max-w-2xl mx-auto text-muted-gray font-sans normal-case text-xl">
          One mission. One nation. Two unlikely athletes representing Greece on the world pickleball stage.
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-muted-gray font-sans normal-case leading-relaxed text-lg">
          Follow the journey from Athens to the Pickleball World Cup in this faith-filled international docuseries.
        </p>
      </div>
    </div>
  );
...
export default ServingForGreece;