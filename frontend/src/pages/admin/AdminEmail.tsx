...
const EmailLogs = React.lazy(() => import('./EmailLogs'));
const AdminEmailAccounts = React.lazy(() => import('./AdminEmailAccounts'));
const AdminEmailInbox = React.lazy(() => import('./AdminEmailInbox'));
...
const AdminEmail = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-heading text-accent-yellow">Email</h1>
        <p className="text-muted-gray">Manage platform email accounts, inboxes, and delivery logs</p>
      </div>
