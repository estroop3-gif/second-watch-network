  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-heading text-accent-yellow">Lead Queue</h1>
          <p className="text-muted-gray mt-1">
            {data?.total || 0} unassigned leads waiting for assignment
          </p>
        </div>
        <Button
          variant="outline"
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-muted-gray">No unassigned leads right now.</p>
        </div>
      ) : (
