...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-charcoal-black data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
...
>(({ className, children, hideCloseButton, ariaLabel, ariaDescription, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    ...
    >
      <VisuallyHidden.Root asChild>
        <DialogPrimitive.Title>{ariaLabel || "Dialog"}</DialogPrimitive.Title>
      </VisuallyHidden.Root>
      {ariaDescription && (
        <VisuallyHidden.Root asChild>
