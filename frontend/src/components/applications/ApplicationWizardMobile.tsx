...
import { StepIndicator, StepNavigation, ReviewStep } from './wizard';
...
interface ApplicationWizardMobileProps {
  isOpen: boolean;
  onClose: () => void;
...
const ApplicationWizardMobile: React.FC<ApplicationWizardMobileProps> = ({
  isOpen,
  onClose,
  collab,
  form,
          ...
          <div className="space-y-4">
            ...
            {collab.requires_self_tape && collab.tape_workflow === 'upfront' && (
              <div className="space-y-2">
                ...
                {collab.tape_format_preferences && (
                  <p className="text-xs text-muted-gray">Format: {collab.tape_format_preferences}</p>
                )}
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-charcoal-black/50 border-muted-gray/30 text-bone-white placeholder:text-muted-gray"
              />
              <p className="text-xs text-muted-gray">Separate skills with commas</p>
            </div>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="h-32 bg-charcoal-black/50 border-muted-gray/30 text-bone-white placeholder:text-muted-gray"
              />
            </div>
  ...
  return (
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DrawerContent className="h-[100dvh] max-h-[100dvh] flex flex-col bg-charcoal-black border-t border-muted-gray/30">
        {/* Header with close button */}
        <div className="flex items-center justify-between px-4 pt-2">
          <DrawerHeader className="p-0">
            <DrawerTitle className="text-lg text-accent-yellow">
              Apply: {collab.title}
            </DrawerTitle>
            <DrawerDescription className="text-sm text-muted-gray">
...
export default ApplicationWizardMobile;
