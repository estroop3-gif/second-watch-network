...
export const BADGE_CONFIGS: Record<RoleType, BadgeConfig> = {
  superadmin: {
    ...
    cssClass: 'bg-gradient-to-r from-red-600 to-yellow-500 text-white font-bold',
    priority: 1,
  ...
  admin: {
    ...
    label: 'Admin',
    shortLabel: 'ADMIN',
    cssClass: 'bg-accent-yellow text-charcoal-black font-bold',
    priority: 2,
  ...
  moderator: {
    ...
    label: 'Moderator',
    shortLabel: 'MOD',
    cssClass: 'bg-purple-600 text-white font-bold',
    priority: 3,
  ...
  lodge_officer: {
    ...
    cssClass: 'bg-gradient-to-r from-yellow-600 to-amber-500 text-white font-bold',
    priority: 4,
  ...
  partner: {
    ...
    label: 'Partner',
    shortLabel: 'PARTNER',
    cssClass: 'bg-blue-500 text-white font-bold',
    priority: 6,
  ...
  filmmaker: {
    ...
    cssClass: 'bg-accent-yellow/80 text-charcoal-black font-bold',
    priority: 7,
  ...
  premium: {
    ...
    label: 'Premium',
    shortLabel: 'PREMIUM',
    cssClass: 'bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold',
    priority: 8,
  ...
  free: {
    ...
    label: 'Free',
    shortLabel: 'FREE',
    cssClass: 'bg-muted-gray text-bone-white',
    priority: 9,
